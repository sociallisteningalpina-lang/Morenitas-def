    ...
    <head>
        ...
        <style>
            * {{ margin: 0; padding: 0; box-sizing: border-box; }}
            ...
            .chart-container.topics-chart {{ height: 600px; grid-column: 1 / -1; }}
        ...
        <div class="container">
            ...
            <div class="card charts-section">
                ...
                <div class="charts-grid">
                    ...
                    <div class="chart-container topics-chart"><canvas id="topicsChart"></canvas></div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {{
                ...
                const updateCharts = (postsData, filteredData) => {{ 
                    ...
                    // Paleta de colores para temas (extendida para más categorías)
                    const topicColors = [
                        '#3498db', '#e74c3c', '#f39c12', '#9b59b6', '#1abc9c', 
                        '#34495e', '#e67e22', '#16a085', '#c0392b', '#27ae60',
